...
insert into products (name, producer, count, price) VALUES ('product_6', 'producer_6', 16, 85);
insert into products (name, producer, count, price) VALUES ('product_7', 'producer_7', 26, 15);

savepoint second_savepoint;

select * from products;

delete from products where count < 15;
